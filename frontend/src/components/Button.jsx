...
return (
    <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        {buttonText === ("Sign Up") && !isMobile && <h1 className="self-center text-1x1 font-semibold dark:text-white mr-2">Don't have an account? </h1>}
        {buttonText === ("Sign in") && !isMobile && <h1 className="self-center text-1x1 font-semibold dark:text-white mr-2">Already have an account? </h1>}
