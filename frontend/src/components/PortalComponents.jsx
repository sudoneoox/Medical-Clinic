...
export const DoctorPortal = ({ userName }) => {
  ...
  return (
    <MainFrame userName={userName} userRole="Doctor" sidebarItems={sidebarItems}>
...
export const ReceptionistPortal = ({ userName }) => {
  ...
  return (
    <MainFrame userName={userName} userRole="Receptionist" sidebarItems={sidebarItems}>
...
export const PatientPortal = ({ userName }) => {
  ...
  return (
    <MainFrame userName={userName} userRole="Patient" sidebarItems={sidebarItems}>
      ...
      {/* TODO: patient-specific components */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold mb-4">Recent Medical Records</h3>
